...
export const CreateWorkerModal = ({ isOpen, onClose, onSuccess }: { isOpen: boolean; onClose: () => void; onSuccess: () => void }) => {
    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-card border border-border rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden">
        <div className="flex items-center justify-between p-5 border-b border-border">
          <h2 className="text-xl font-bold text-foreground">Nuevo Trabajador / Maestro</h2>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-1.5 col-span-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  placeholder="Ej. Abigail Jimenez"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-background border border-border rounded-xl pl-10 pr-4 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-indigo-500"
                  placeholder="Ej. Ceramista / Maestro Primera"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <label className="text-sm font-medium text-muted-foreground">Calificación Inicial</label>
              <div className="relative">
          ...
          <div className="space-y-1.5">
            ...
            <input 
              ...
              placeholder="Ej. Ceramico, Pintura, Carpintería"
            />
          </div>

          <div className="space-y-1.5">
            <label className="text-sm font-medium text-muted-foreground">Historial / Notas / Rendimiento</label>
            <div className="relative">
              ...
              <textarea 
                ...
                placeholder="Ej. Buen rendimiento en terminaciones, trabajamos en 20 obras..."
              />
            </div>
          </div>
